...
void SquareRenderer::RenderSquare(glm::vec2 position, glm::vec2 size, glm::vec3 color, glm::vec3 borderColor, float borderSize, GLfloat transperancy, GLfloat rotate)
{
	...
	model = glm::scale(model, glm::vec3(size, 1.0f));								// Last scale
	this->squareShader_ui.SetMatrix4("model", model);
	this->squareShader_ui.SetVector3f("colorUniform", borderColor);
...
void SquareRenderer::RenderSquare(glm::vec2 position, glm::vec2 size, glm::vec3 color, GLfloat transperancy, GLfloat rotate)
{
	this->squareShader_ui.Use();
	glm::mat4 model = glm::mat4(1.0);
	model = glm::translate(model, glm::vec3(position, 0.0f)); // First translate (transformations are: scale happens first, then rotation and then finall translation happens; reversed order)
...
void SquareRenderer::world_RenderSquare(glm::vec2 position, glm::vec2 size, glm::vec3 color, GLfloat transperancy, GLfloat rotate)
{
...
void SquareRenderer::world_RenderEmptySquareWithLine(glm::vec2 position, glm::vec2 size, glm::vec3 color, float lineSize, GLfloat transperancy, GLfloat rotate)
{
	...
	this->world_RenderSquare(pos, siz, color, transperancy, rotate);

...
void Shader::SetVector2f(const GLchar *name, float x, float y,
                         GLboolean useShader) const
{
...
void Shader::SetVector3f(const GLchar *name, float x, float y, float z,
                         GLboolean useShader) const
{
...
void Shader::SetVector4f(const GLchar *name, float x, float y, float z,
                         float w, GLboolean useShader) const
{
